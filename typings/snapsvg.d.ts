...
declare module 'snapsvg' {
    export function mina(a: number, A: number, b: number, B: number, get: Function, set: Function, easing?: (num: number) => number): mina.AnimationDescriptor;
    ...
    export function Snap(width: number | string, height: number | string): Snap.Paper;
    export function Snap(query: string): Snap.Paper;
    export function Snap(DOM: SVGElement): Snap.Paper;
