...
/******/ 	__webpack_require__.p = "/home/rick/code/farmbot/frontend/public/app-resources";
/******/
...
var API = (function () {
    ...
    API.fetchBrowserLocation = function () {
        return "//" + window.location.hostname + ":" + API.inferPort();
    };
    API.fetchHostName = function () {
    ...
    ;
    Object.defineProperty(API.prototype, "tokensPath", {
        /** /api/tokens/ */
        get: function () { return this.baseUrl + "/api/tokens/"; },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(API.prototype, "passwordResetPath", {
        /** /api/password_resets/ */
        get: function () { return this.baseUrl + "/api/password_resets/"; },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(API.prototype, "devicePath", {
        /** /api/device/ */
        get: function () { return this.baseUrl + "/api/device/"; },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(API.prototype, "usersPath", {
        /** /api/users/ */
        get: function () { return this.baseUrl + "/api/users/"; },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(API.prototype, "peripheralsPath", {
        /** /api/peripherals/ */
        get: function () { return this.baseUrl + "/api/peripherals/"; },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(API.prototype, "plantsPath", {
        /** /api/plants/ */
        get: function () { return this.baseUrl + "/api/plants/"; },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(API.prototype, "regimensPath", {
        /** /api/regimens/ */
        get: function () { return this.baseUrl + "/api/regimens/"; },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(API.prototype, "sequencesPath", {
        /** /api/sequences/ */
        get: function () { return this.baseUrl + "/api/sequences/"; },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(API.prototype, "syncPath", {
        /** /api/sync/ */
        get: function () { return this.baseUrl + "/api/sync/"; },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(API.prototype, "toolBaysPath", {
        /** /api/tool_bays/ */
        get: function () { return this.baseUrl + "/api/tool_bays/"; },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(API.prototype, "toolSlotsPath", {
        /** /api/tool_slots/ */
        get: function () { return this.baseUrl + "/api/tool_slots/"; },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(API.prototype, "toolsPath", {
        /** /api/tools/ */
        get: function () { return this.baseUrl + "/api/tools/"; },
        enumerable: true,
        configurable: true
    });
    ;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(54)(module), __webpack_require__(17)))
...
function getParam(name) {
    ...
    var regex = new RegExp("[\\?&]" + name + "=([^&#]*)"), r = regex.exec(location.search);
...
function randomColor() {
    return _.sample(exports.colors);
}
exports.randomColor = randomColor;
function defensiveClone(target) {
    var jsonString = JSON.stringify(target);
    return JSON.parse(jsonString || "null");
}
exports.defensiveClone = defensiveClone;
;
/** Concats and capitalizes all of the error key/value
 *  pairs returned by the /api/xyz endpoint. */
function prettyPrintApiErrors(err) {
    return _.map(safelyFetchErrors(err), function (v, k) { return (k + " " + v.toString() + ".").toLowerCase(); })
        .map(function (str) { return _.capitalize(str); }).join(" ");
}
exports.prettyPrintApiErrors = prettyPrintApiErrors;
/** */
function safelyFetchErrors(err) {
...
function move(array, moveIndex, toIndex) {
    ...
    if (diff > 0) {
        // move left
        return array.slice(0, toIndex).concat([
            item
        ], array.slice(toIndex, moveIndex), array.slice(moveIndex + 1, length));
    }
    else if (diff < 0) {
        // move right
        return array.slice(0, moveIndex).concat(array.slice(moveIndex + 1, toIndex + 1), [
            item
...
function verify() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    token = util_1.getParam('token');
                    url = api_1.API.fetchBrowserLocation();
                    return [4 /*yield*/, axios_1.put(url + "/api/users/verify/" + token)];
                case 1:
                    data = (_a.sent()).data;
                    session_1.Session.put(data);
...
var boxed_value_1 = __webpack_require__(171);
var Session;
(function (Session) {
    var KEY = "session";
    /** Replace the contents of session storage. */
    function put(nextState) {
    ...
    function get() {
        try {
            ...
            if (boxed_value_1.box(v).kind === "object") {
                return v;
            }
            else {
